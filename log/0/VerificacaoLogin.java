...
public class VerificacaoLogin {
    ...
    public static void main(String[] args) {
        ...
        realizarLogin("admin", "12345", usuarioCorreto, senhaCorreta);
        realizarLogin("admin", "senhaErrada", usuarioCorreto, senhaCorreta);
        realizarLogin("usuarioDesconhecido", "12345", usuarioCorreto, senhaCorreta);
    }
